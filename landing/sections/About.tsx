        ...
        <Stack sx={{ alignItems: "center", justifyContent: "space-between" }}>
          <Stack direction="column" width={{ xs: "100%", lg: "70%" }}>
            ...
            <Typography>
              ...
              деятельность, освещать проблемы женщин (в том числе специфические,
              связанные с эмиграцией):
            </Typography>
            ...
            <Typography>
              Каждое воскресенье проводим фемзавтраки в разных форматах.
              Например, пикник, распродажа, "просто поныть", общение,
              арт-медитация, дискуссии на актуальные темы
            </Typography>

            <Typography>
              Каждый второй четверг — лекции, на которых мы изучаем и обсуждаем
              волны феминизма, феминитивы, стереотипы и т.п. В наших
              мероприятиях принимают участие мужчины, женщины и небинарные люди.
              Здесь можно открыто делиться своими проблемами, трудностями и
              получить понимание и поддержку. Сейчас у нас формируется
              психологическая группа поддержки: первая - для поддержи родителей
              в эмиграции, вторая - для тех, у кого нет детей.
            </Typography>
